...
Atmosphere - Spacious, Intimate, Bright, Dark, Ethereal
Instruments - Piano, Guitar, Strings, Woodwinds, Brass, etc.
Drums & Percussion - Acoustic, Electronic, Breakbeat, Jazz, etc.
...
Suno Prompts
Static React app to browse and manage Suno AI prompts stored as JSON in the repo.
